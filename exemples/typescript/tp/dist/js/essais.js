...
l1.couleur = "blue";
let l2 = new line_1.Line(10, 40, 230, 300, "red"); //avec coordonnées fixées dès la construction
//via constructor()
console.log("l2=" + JSON.stringify(l2));
//l2.couleur="red";
//ESSAIS SUR LES CERCLES:
let c1 = new circle_1.Circle();
...
let c2 = new circle_1.Circle(250, 250, 30); //avec  constructor(xc,yc,r)
...
tabFig.push(new line_1.Line(12, 34, 345, 343, "orange"));
tabFig.push(new circle_1.Circle(200, 200, 100, "red"));
