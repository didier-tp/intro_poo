...
function loadDevisesWithAjax(){
    ...
    makeAjaxGetRequest("../devise-api/Devise" ,  function(texteReponse){
...
function postNewDeviseWithAjax(nouvelleDevise){
    ...
    makeAjaxPostRequest( "../devise-api/Devise" ,
...
function putNewValueOfExistingDeviseWithAjax(deviseToUpdate){
    makeAjaxPutRequest("../devise-api/Devise" ,
...
function deleteOldDeviseWithAjax(oldDevise){
    ...
    //***************************************
    let deleteUrl= "../devise-api/Devise/" + oldDevise.code
